...
ENTRYPOINT ["sh", "-c", "java -Xms256m -Xmx512m -XX:+UseContainerSupport -XX:MaxRAMPercentage=75 -Djava.security.egd=file:/dev/./urandom $JAVA_OPTS org.springframework.boot.loader.JarLauncher"]
